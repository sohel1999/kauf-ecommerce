            ...
            <ul class="navbar-nav ml-auto navbar-right-top">
                ...
                <li class="nav-item dropdown nav-user">
                    ...
                    <div class="dropdown-menu dropdown-menu-right nav-user-dropdown" aria-labelledby="navbarDropdownMenuLink2">
                        ...
                        <form id="logout" action="{{route('backend.logout.post')}}" method="post">
                            @csrf
                        </form>
                        <button onclick="document.getElementById('logout').submit()" class="dropdown-item" ><i class="fas fa-power-off mr-2"></i>Logout</button>
                    </div>
                </li>
            </ul>
        </div>
